...
public class FabricGateway {
    ...
    public static String certificatePath = "src/main/resources/crypto-config/peerOrganizations/org1.example.com/users/User1@org1.example.com/msp/signcerts/User1@org1.example.com-cert.pem";
    public static String privateKeyPath = "src/main/resources/crypto-config/peerOrganizations/org1.example.com/users/User1@org1.example.com/msp/keystore/priv_sk";
    public static String tlsCertPath="src/main/resources/crypto-config/peerOrganizations/org1.example.com/peers/peer0.org1.example.com/tls/ca.crt";
    public static String mspId="Org1MSP";
    public static Gateway gateway() throws Exception {
